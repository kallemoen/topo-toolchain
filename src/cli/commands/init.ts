...
export function runInit(opts: InitOptions): number {
  ...
  // 6. next steps — tailored to whether the first scan found any markers
  if (systemCount === 0) {
